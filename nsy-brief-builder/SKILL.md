...
1. **Brief Link** - Set the "Brief Link" property to the PLAIN TEXT Notion URL of the newly created brief page. Do NOT format it as a markdown link or hyperlink. Just the raw URL string: `https://www.notion.so/[page-id]`
...
20. **Brief Link must always be plain text URL. Never format it as a markdown link, hyperlink, or clickable link. Just the raw URL string.**
